const logotext = "Newton Brian";
const meta = {
    title: "Newton Brian Nyongesa",
    description: "Newton Brian Nyongesa _ Full stack devloper,currently working an internship at Bitz.itc company ",
};
...
const introdata = {
    ...
    your_img_url: "https://images.app.goo.gl/SHPAcEkBK8Eip3er9",
};
...
const worktimeline =[ 
    ...
    },
    {
      ...
      where: "Wordandlearn",
      date: "Present",
      description: "Worked on the design and UI aspects of the Wordandlearn application, focusing on creating an intuitive and engaging user experience.",
    },
    {
    ...
    {
      jobtitle: "A2SV Hackathon Semi-Finalist",
